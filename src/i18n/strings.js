...
export const STRINGS = {
  en: {
    ...
    // accommodation — several options for the same night
    acc_option: "Option {n}",
    ...
    bk_empty: "Nothing booked yet — mark a stay or an activity as booked and it shows up here.",
    bk_unnamed: "(unnamed)",
    bk_per_night: "/night",
    bk_agency: "Agency",
    ...
    bk_note_multi: "Some nights hold more than one booked option — cancel the extras before their free-cancellation date so you aren't charged twice.",
  ...
  es: {
    ...
    // alojamiento — varias opciones para la misma noche
    acc_option: "Opción {n}",
    ...
    bk_note_multi: "Algunas noches tienen más de una opción reservada — cancela las de sobra antes de su fecha de cancelación gratis para no pagar dos veces.",
