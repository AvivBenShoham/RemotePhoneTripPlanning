...
export const STRINGS = {
  en: {
    ...
    // accommodation — one booking per place, several options possible
    acc_covers: "One booking for the whole stay · {range} · {n} {nights}",
    acc_price_stay: "Price · {n} nights total (USD)",
    acc_mode_night: "per night",
    acc_mode_total: "total for {n} nights",
    acc_price_breakdown: "{total} for {n} nights · {nightly}/night",
    acc_price_default: "{nightly}/night (default)",
    acc_option: "Option {n}",
    acc_options_count: "{n} options",
    acc_booked_n: "✅ {n} booked",
    acc_add_option: "＋ Add another option",
    acc_remove_option: "Remove this option",
    acc_remove_confirm: "Remove this booking option?",
    acc_pick_main: "Use as main pick",
    acc_chosen: "★ Main pick",
    acc_in_total: "counts in the totals",
    // booked tab
    bk_total_booked: "Booked (USD)",
    bk_stays_count: "Booked stays",
    bk_acts_count: "Booked activities",
    bk_open_deadlines: "Open cancel windows",
    bk_head_stays: "🏨 Booked stays",
    bk_head_acts: "🎟️ Booked activities & tours",
    bk_head_deadlines: "⏳ Free-cancellation deadlines",
    bk_empty: "Nothing booked yet — mark a place or an activity as booked and it shows up here.",
    bk_unnamed: "(unnamed)",
    bk_per_night: "/night",
    bk_nights_total: " · {n} nights",
    bk_agency: "Agency",
    bk_main_pick: "★ Main pick",
    bk_extra_option: "Option {n} of {m}",
    bk_cancel_in: "cancel free until {date} · {n} days left",
    bk_cancel_tomorrow: "last day to cancel free is tomorrow",
    bk_cancel_today: "last day to cancel free is today",
    bk_cancel_passed: "🔒 free cancellation ended {date}",
    bk_note_multi: "Some places have more than one booked reservation — cancel the extras before their free-cancellation date so you aren't charged twice.",
    bk_reminders_note: "Email reminders go out 2 days and 1 day before each free-cancellation date.",
    // optionals
  ...
  es: {
    ...
    // alojamiento — una reserva por lugar, con varias opciones posibles
    acc_covers: "Una reserva para toda la estancia · {range} · {n} {nights}",
    acc_price_stay: "Precio · total {n} noches (USD)",
    acc_mode_night: "por noche",
    acc_mode_total: "total {n} noches",
    acc_price_breakdown: "{total} por {n} noches · {nightly}/noche",
    acc_price_default: "{nightly}/noche (predet.)",
    acc_option: "Opción {n}",
    acc_options_count: "{n} opciones",
    acc_booked_n: "✅ {n} reservadas",
    acc_add_option: "＋ Añadir otra opción",
    acc_remove_option: "Eliminar esta opción",
    acc_remove_confirm: "¿Eliminar esta opción de reserva?",
    acc_pick_main: "Usar como principal",
    acc_chosen: "★ Principal",
    acc_in_total: "cuenta en los totales",
    // pestaña reservado
    bk_total_booked: "Reservado (USD)",
    bk_stays_count: "Alojamientos reservados",
    bk_acts_count: "Actividades reservadas",
    bk_open_deadlines: "Cancelaciones abiertas",
    bk_head_stays: "🏨 Alojamientos reservados",
    bk_head_acts: "🎟️ Actividades y tours reservados",
    bk_head_deadlines: "⏳ Fechas límite de cancelación gratis",
    bk_empty: "Aún no hay nada reservado — marca un alojamiento o una actividad como reservada y aparecerá aquí.",
    bk_unnamed: "(sin nombre)",
    bk_per_night: "/noche",
    bk_nights_total: " · {n} noches",
    bk_agency: "Agencia",
    bk_main_pick: "★ Principal",
    bk_extra_option: "Opción {n} de {m}",
    bk_cancel_in: "cancelación gratis hasta {date} · faltan {n} días",
    bk_cancel_tomorrow: "mañana es el último día para cancelar gratis",
    bk_cancel_today: "hoy es el último día para cancelar gratis",
    bk_cancel_passed: "🔒 la cancelación gratis terminó el {date}",
    bk_note_multi: "Algunos lugares tienen más de una reserva — cancela las de sobra antes de su fecha de cancelación gratis para no pagar dos veces.",
    bk_reminders_note: "Los recordatorios por correo se envían 2 días y 1 día antes de cada fecha de cancelación gratis.",
    // optionals
