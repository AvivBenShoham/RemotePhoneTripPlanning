  ...
  return (
    <>
      ...
      <aside className={'panel' + (open ? ' open' : '')}>
        ...
        <div className="noteblk warn"><h4>🚌 Bus times — verified, but confirm locally</h4><p>Schedules were checked against operator sources, but Dominican departure times drift and none of these buses can be booked online — it's <b>cash, in person, day-of</b>. Confirm each connection the day before.</p><p>Key times: <b>Asotrapusa</b> SD→Las Terrenas 08:30/09:30/11:00/13:40/15:00/18:00; Las Terrenas→SD 05:00/07:00/09:00/11:00/14:00/15:30. <b>La Romana→Bávaro</b> 05:40/08:20/10:50/13:20/15:20. <b>Bayahibe guaguas</b> every ~20 min, last ~18:00. <b>Expreso Bávaro</b> first bus 07:00.</p></div>
